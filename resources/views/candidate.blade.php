    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-center bg-olive">
                <h4 class="fw-bolder">DAFTAR KANDIDAT KETUA UMUM OSIS</h4>
                <h4 class="fw-bolder">{{ strtoupper(GlobalHelper::setting('instansi')) }}</h4>
                <h4 class="fw-bolder">PERIODE {{ Carbon::now()->format('Y') . ' - ' . (Carbon::now()->format('Y') + 1) }}</h4>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="accordion accordion-flush" id="accordionFlush-{{ $index + 1 }}">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed btn-light-yellow" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#visi-{{ $index + 1 }}" aria-expanded="false" aria-controls="visi-{{ $index + 1 }}">
                                                    VISI
                                                </button>
                                            </h2>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed btn-light-yellow" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#misi-{{ $index + 1 }}" aria-expanded="false" aria-controls="misi-{{ $index + 1 }}">
                                                    MISI
                                                </button>
                                            </h2>
